...
import './globals.css'
import { getSiteUrl, getStoreName, getFbPixelId, getFbDomainVerification } from '@/lib/server-env'

const inter = Inter({ subsets: ['latin'] })
const storeName = getStoreName()
const siteUrl = getSiteUrl()
const fbDomainVerification = getFbDomainVerification()
...
export const metadata: Metadata = {
  ...
  ...(fbDomainVerification && {
    other: { 'facebook-domain-verification': fbDomainVerification },
  }),
}

export default function RootLayout({ children }: { children: React.ReactNode }) {
  const fbPixelId = getFbPixelId()
